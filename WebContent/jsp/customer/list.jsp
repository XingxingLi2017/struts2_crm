											...
											<TBODY>
												...
												<s:iterator value="list" var="item">
													<TR
														...
														<TD><s:property value="#item.cust_name" /></TD>
														<TD><s:property value="#item.cust_level" /></TD>
														<TD><s:property value="#item.cust_source" /></TD>
														<TD><s:property value="#item.cust_industry"/></TD>
														<TD><s:property value="#item.cust_phone" /></TD>
														<TD><s:property value="#item.cust_mobile" /></TD>
														<TD>
